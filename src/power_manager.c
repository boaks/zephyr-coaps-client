...
static atomic_t regulator_count = ATOMIC_INIT(DT_PROP_OR(REGULATOR_NODE, regulator_boot_on, 0U));
...
#ifndef CONFIG_NRF_MODEM_LIB_TRACE
   power_manager_suspend_device(DEVICE_DT_GET_OR_NULL(DT_CHOSEN(nordic_modem_trace_uart)));
