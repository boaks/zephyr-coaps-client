...
#define COAP_SEND_FLAG_LOCATION_TRIGGER 4096
...
#define COAP_SEND_FLAG_LOCATION_TRIGGER_ COAP_SEND_FLAG_LOCATION_TRIGGER
#else
#define COAP_SEND_FLAG_LOCATION_TRIGGER_ 0
#endif
...
#define COAP_SEND_FLAGS_ALL (COAP_SEND_FLAG_MODEM_INFO_ | COAP_SEND_FLAG_SIM_INFO_ |    \
                             ...
                             COAP_SEND_FLAG_SCALE_INFO_ | COAP_SEND_FLAG_LOCATION_TRIGGER_)
