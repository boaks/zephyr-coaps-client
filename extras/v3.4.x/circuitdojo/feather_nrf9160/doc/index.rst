...
* Raspberry Pi Pico Probe (recommended)
* J-Link
* CMSIS-DAP based programmers

Check out `Getting Started`_ for more info. More information can also be found in `Debugging`_
...
.. _nRF9160 Feather Documentation: https://docs.circuitdojo.com/nrf9160-introduction.html
.. _Getting Started: https://docs.circuitdojo.com/nrf9160-getting-started.html
.. _Debugging: https://docs.circuitdojo.com/nrf9160-programming-and-debugging.html