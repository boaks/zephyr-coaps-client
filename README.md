...
| [**NEW** Circuit Dojo, nRF9151 feather (only with NCS 2.9.x or newer)](https://www.circuitdojo.com/products/nrf9151-feather)<br>Requires additional batteries, antennas, and closures to work in the "wild". Comes with motion sensor, 16MB flash and onboard OCD. The design of the feather allows to easily add custom sensors. | [<img src="https://www.circuitdojo.com/base/api/files/products/515ssdvlohrn7es/n_rf9151_feather_front_centered_zVodQCvzhu.png" width="300"/>](https://www.circuitdojo.com/base/api/files/products/515ssdvlohrn7es/n_rf9151_feather_front_centered_zVodQCvzhu.png) |
